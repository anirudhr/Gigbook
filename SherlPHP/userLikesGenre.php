...
<html>
	<head>
		<title>Gigbook: Like Genre</title>
...
$uname = $_SESSION['name'];
 ...
 ?></a> <a href="logout.php"><img src="images/logout.png" alt="LOGOUT"/></a></div>
            ...
            <h2>GENRES YOU LIKE</h2>
				<table border="0" width="100%" cellspacing="20">
<tr><td colspan="2"  ><input type="button" value="MORE GENRE" onclick="window.location='genre.php'"/></td><td>
<form action="searchGenre.php" method="post">
<input type="text" value="" placeholder="Enter band name" name="genre" id="genre"/>
