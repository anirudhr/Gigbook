...
CREATE PROCEDURE sp_insert_concert_band_or_system(IN inp_bname VARCHAR(20), IN inp_cname VARCHAR(20), IN inp_vname VARCHAR(20), IN inp_ctime CHAR(16), IN inp_tkturl VARCHAR(64), IN inp_cover DECIMAL) /*if inp_cname or inp_tkturl are NULL, they will be inserted as NULL values*/
=======
CREATE PROCEDURE sp_insert_concert_band_or_system(IN inp_bname VARCHAR(50), IN inp_cname VARCHAR(50), IN inp_vname VARCHAR(50), IN inp_ctime CHAR(16), IN inp_tkturl VARCHAR(64), IN inp_cover DECIMAL) /*if inp_cname or inp_tkturl are NULL, they will be inserted as NULL values*/
>>>>>>> testingSP
BEGIN
